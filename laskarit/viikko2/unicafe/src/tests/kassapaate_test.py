...
#käteisosto, ei tarpeeksi rahaa:
    ...
    def test_edullinen_lounas_kateisosto_ei_tarpeeksi_rahaa_ei_myyntiä(self):
...
#käteinen, ei rahaa tarpeeksi, maukas lounas:
    def test_maukas_lounas_kateisosto_ei_tarpeeksi_rahaa_vaihtoraha_oikein(self):
...
#rahaa kortilla, edullinen lounas:     
    ...
    def test_edullinen_lounas_korttiosto_rahaa_tarpeeksi_palauttaa_true(self):
...
#rahaa kortilla, maukas lounas:
    ...
    def test_maukas_lounas_korttiosto_rahaa_tarpeeksi_palauttaa_true(self):
...
#ei rahaa kortilla, maukas lounas:
    ...
    def test_maukas_lounas_korttiosto_ei_rahaa_kassan_saldo_ei_muutu(self):
        self.kassapaate.syo_maukkaasti_kortilla(self.tyhjakortti)  
        self.assertEqual(str(self.kassapaate.kassassa_rahaa), "100000")

    def test_maukas_lounas_korttiosto_ei_rahaa_palauttaa_false(self):
 ...
 #ei rahaa kortilla, edullinen lounas:   
    ...
    def test_edullinen_lounas_korttiosto_ei_rahaa_palauttaa_false(self):
        a = self.kassapaate.syo_edullisesti_kortilla(self.tyhjakortti)
        self.assertEqual(a, False)



    def test_negatiivisen_summan_lataus_kortille_kassan_saldo_ei_muuttu(self):
        self.kassapaate.lataa_rahaa_kortille(self.maksukortti,-1000)
        self.assertEqual(str(self.kassapaate.kassassa_rahaa), "100000")
        

    def test_negatiivisen_summan_lataus_kortille_kortin_saldo_ei_muuttu(self):
        self.kassapaate.lataa_rahaa_kortille(self.maksukortti,-1000)        
        self.assertEqual(str(self.maksukortti), "saldo: 1000.0")
    ...
    def test_rahan_lataus_kortille_kortin_saldo_muuttuu_oikein(self):
        self.kassapaate.lataa_rahaa_kortille(self.maksukortti,1000)
