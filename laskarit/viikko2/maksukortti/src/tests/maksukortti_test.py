...
class TestMaksukortti(unittest.TestCase):
    ...
    def negatiivisen_summan_lataaminen_ei_muuta_kortin_saldoa_ei_ylita_maksimiarvoa(self):
    ...
    def test_syo_edullisesti_kaikella_rahalla(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa "+ str(0.0)+ " euroa")

    def test_syo_maukkaasti_kaikella_rahalla(self):
        self.kortti.lataa_rahaa(2)
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa "+str(0)+ " euroa")